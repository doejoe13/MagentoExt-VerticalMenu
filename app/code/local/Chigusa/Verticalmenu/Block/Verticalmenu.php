<?php
class Chigusa_Verticalmenu_Block_Verticalmenu extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawCustomMenuItem($category, $level = 0, $last = false, $class='')
    {
        ...
        if ($drawPopup)
        {  
            $html[] = '<div id="chigusa-pt-menu' . $id . '" class="chigusa-pt-menu' . $active . ' '.$class.' " >';
        }
        else
        {
            $html[] = '<div id="chigusa-pt-menu' . $id . '" class="chigusa-pt-menu' . $active .' '.$class.'">';
        ...
        // --- Top Menu Item ---
        $html[] = '<div class="chigusa-parent-menu'.$hasSubMenu.'">';
        ...
        if ($drawPopup)
        {
            ...
            $html[] = '<div class="wrap-chigusa-wrap-popup">';
